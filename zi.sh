...
# ============================================================================
# ZIVPN INSTALLER - AMD64 (x86_64)
# ============================================================================
# Script instalasi ZIVPN untuk arsitektur AMD64/x86_64
# Cocok untuk: VPS dengan processor Intel/AMD 64-bit
# ============================================================================
...
# ----------------------------------------------------------------------------
# STEP 3: DOWNLOAD BINARY ZIVPN (AMD64)
# ----------------------------------------------------------------------------
echo -e "Downloading UDP Service"
wget https://github.com/soakstore/udp-zivpn/releases/download/V1/udp-zivpn-linux-amd64 -O /usr/local/bin/zivpn
