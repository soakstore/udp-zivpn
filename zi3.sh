...
# ============================================================================
# ZIVPN INSTALLER - ARM (32-bit)
# ============================================================================
# Script instalasi ZIVPN untuk arsitektur ARM 32-bit
# Cocok untuk: Raspberry Pi 2/3, perangkat ARM lama
# ============================================================================
...
# ----------------------------------------------------------------------------
# STEP 3: DOWNLOAD BINARY ZIVPN (ARM 32-bit)
# ----------------------------------------------------------------------------
echo -e "Downloading UDP Service"
wget https://github.com/soakstore/udp-zivpn/releases/download/V1/udp-zivpn-linux-arm -O /usr/local/bin/zivpn
